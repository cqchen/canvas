...
;(function(w){
    function Context(cts,input){
        ...
        this.gradient = this.cts.createLinearGradient(0, 0, this.width, 0);
        this.gradient.addColorStop(0, '#ff0000');
        this.gradient.addColorStop(0.5, '#ff1000');
        this.gradient.addColorStop(1.0, '#9ac054');
    ...
    Context.prototype={
        ...
        _draw:function(){
            ...
            for(var i=0;i<this.arr.length;i++){
                ...
                this.cts.fillStyle = this.gradient;
                this.cts.fill();
            } 
        },
   		_getText:function(){
